...
public class ConnectedMultiFieldsSimpleQueryStringQueryBuilder implements SimpleQueryStringTermination {
    ...
    private SearchPredicate createPredicate() {
        ...
        SimpleQueryStringPredicateOptionsStep<?> optionsStep = fieldMoreStep.matching(simpleQueryString).defaultOperator(withAndAsDefaultOperator ? BooleanOperator.AND : BooleanOperator.OR);
