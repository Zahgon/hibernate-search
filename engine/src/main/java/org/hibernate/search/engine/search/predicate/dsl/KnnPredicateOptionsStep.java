 ...
 */
public interface KnnPredicateOptionsStep<SR> extends PredicateScoreStep<KnnPredicateOptionsStep<SR>>, PredicateFinalStep {
    ...
    KnnPredicateOptionsStep<SR> filter(Function<? super TypedSearchPredicateFactory<SR>, ? extends PredicateFinalStep> clauseContributor);
