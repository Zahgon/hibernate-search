...
public interface MatchPredicateFieldStep<SR, N extends MatchPredicateFieldMoreStep<?, ?>> {
    ...
    default <T> MatchPredicateFieldMoreGenericStep<?, ?, T, MatchPredicateFieldReference<? super SR, T>> field(MatchPredicateFieldReference<? super SR, T> fieldReference) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @SuppressWarnings("unchecked")
    <T> MatchPredicateFieldMoreGenericStep<?, ?, T, MatchPredicateFieldReference<? super SR, T>> fields(MatchPredicateFieldReference<? super SR, T>... fieldReferences);
}
