...
class CompositeAggregationFrom3AsStepImpl<V1, V2, V3> extends AbstractCompositeAggregationFromAsStep implements CompositeAggregationFrom3AsStep<V1, V2, V3> {
    ...
    public CompositeAggregationFrom3AsStepImpl(CompositeAggregationBuilder<?> builder, SearchAggregation<V1> inner1, SearchAggregation<V2> inner2, SearchAggregation<V3> inner3) {
        super(builder);
        this.inner1 = inner1;
        this.inner2 = inner2;
        this.inner3 = inner3;
