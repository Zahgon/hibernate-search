...
public class RangeAggregationFieldStepImpl<SR, PDF extends TypedSearchPredicateFactory<SR>> implements RangeAggregationFieldStep<SR, PDF> {
    ...
    @Override
    public <F> RangeAggregationRangeStep<SR, ?, PDF, F, Long> field(String fieldPath, Class<F> type, ValueModel valueModel) {
