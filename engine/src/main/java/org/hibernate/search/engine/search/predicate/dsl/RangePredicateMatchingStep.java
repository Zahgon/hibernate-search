...
public interface RangePredicateMatchingStep<N extends RangePredicateOptionsStep<?>> extends RangePredicateMatchingGenericStep<Object, N> {
    ...
    default N between(Object lowerBoundValue, Object upperBoundValue, org.hibernate.search.engine.search.common.ValueConvert convert) {
        return between(Range.between(lowerBoundValue, upperBoundValue), org.hibernate.search.engine.search.common.ValueConvert.toValueModel(convert));
    }
    ...
    default N atLeast(Object lowerBoundValue, org.hibernate.search.engine.search.common.ValueConvert convert) {
        return within(Range.atLeast(lowerBoundValue), org.hibernate.search.engine.search.common.ValueConvert.toValueModel(convert));
    }
    ...
    default N greaterThan(Object lowerBoundValue, org.hibernate.search.engine.search.common.ValueConvert convert) {
        return within(Range.greaterThan(lowerBoundValue), org.hibernate.search.engine.search.common.ValueConvert.toValueModel(convert));
    }
    ...
    default N atMost(Object upperBoundValue, org.hibernate.search.engine.search.common.ValueConvert convert) {
        return within(Range.atMost(upperBoundValue), org.hibernate.search.engine.search.common.ValueConvert.toValueModel(convert));
    }
    ...
    default N lessThan(Object upperBoundValue, org.hibernate.search.engine.search.common.ValueConvert convert) {
        return within(Range.lessThan(upperBoundValue), org.hibernate.search.engine.search.common.ValueConvert.toValueModel(convert));
    }
