...
public interface RangeAggregationFieldStep<SR, PDF extends TypedSearchPredicateFactory<SR>> {
    ...
    default <F> RangeAggregationRangeStep<SR, ?, PDF, F, Long> field(String fieldPath, Class<F> type, org.hibernate.search.engine.search.common.ValueConvert convert) {
     ...
     * @return The next step.
     */
    default <F> RangeAggregationRangeStep<SR, ?, PDF, F, Long> field(RangeAggregationFieldReference<? super SR, F> fieldReference) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
