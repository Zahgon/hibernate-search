...
public final class NestedPredicateClausesStepImpl<SR> extends AbstractSimpleBooleanPredicateClausesStep<SR, NestedPredicateClausesStepImpl<SR>, NestedPredicateClausesCollector<SR, ?>> implements NestedPredicateClausesStep<SR, NestedPredicateClausesStepImpl<SR>> {

    private final NestedPredicateBuilder builder;

    public NestedPredicateClausesStepImpl(SearchPredicateDslContext<?> dslContext, String objectFieldPath, TypedSearchPredicateFactory<SR> factory) {
