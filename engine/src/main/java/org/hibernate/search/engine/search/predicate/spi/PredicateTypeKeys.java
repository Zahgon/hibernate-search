...
public final class PredicateTypeKeys {
    ...
    public static final SearchQueryElementTypeKey<WildcardPredicateBuilder> WILDCARD = of(IndexFieldTraits.Predicates.WILDCARD);
    ...
    public static final SearchQueryElementTypeKey<SpatialWithinCirclePredicateBuilder> SPATIAL_WITHIN_CIRCLE = of(IndexFieldTraits.Predicates.SPATIAL_WITHIN_CIRCLE);

    public static final SearchQueryElementTypeKey<SpatialWithinPolygonPredicateBuilder> SPATIAL_WITHIN_POLYGON = of(IndexFieldTraits.Predicates.SPATIAL_WITHIN_POLYGON);

    public static final SearchQueryElementTypeKey<SpatialWithinBoundingBoxPredicateBuilder> SPATIAL_WITHIN_BOUNDING_BOX = of(IndexFieldTraits.Predicates.SPATIAL_WITHIN_BOUNDING_BOX);
