...
class CompositeAggregationFrom2AsStepImpl<V1, V2> extends AbstractCompositeAggregationFromAsStep implements CompositeAggregationFrom2AsStep<V1, V2> {

    final SearchAggregation<V1> inner1;

    final SearchAggregation<V2> inner2;

    public CompositeAggregationFrom2AsStepImpl(CompositeAggregationBuilder<?> builder, SearchAggregation<V1> inner1, SearchAggregation<V2> inner2) {
        super(builder);
        this.inner1 = inner1;
        this.inner2 = inner2;
    }
