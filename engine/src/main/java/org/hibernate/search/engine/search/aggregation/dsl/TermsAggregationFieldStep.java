...
public interface TermsAggregationFieldStep<SR, PDF extends TypedSearchPredicateFactory<SR>> {
    ...
    default <F> TermsAggregationValueStep<SR, ?, PDF, F, Map<F, Long>> field(String fieldPath, Class<F> type, org.hibernate.search.engine.search.common.ValueConvert convert) {
     ...
     * @return The next step.
     */
    <F> TermsAggregationValueStep<SR, ?, PDF, F, Map<F, Long>> field(String fieldPath, Class<F> type, ValueModel valueModel);
     ...
     * @return The next step.
     */
    default <F> TermsAggregationValueStep<SR, ?, PDF, F, Map<F, Long>> field(TermsAggregationFieldReference<? super SR, F> fieldReference) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
