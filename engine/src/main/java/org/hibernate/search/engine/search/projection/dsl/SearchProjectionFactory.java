...
public interface SearchProjectionFactory<R, E> {
    ...
    default <T> FieldProjectionValueStep<?, T> field(String fieldPath, Class<T> type, org.hibernate.search.engine.search.common.ValueConvert convert) {
        return field(fieldPath, type, org.hibernate.search.engine.search.common.ValueConvert.toValueModel(convert));
    }
     ...
     */
    @Deprecated(since = "7.2")
    default FieldProjectionValueStep<?, Object> field(String fieldPath, org.hibernate.search.engine.search.common.ValueConvert convert) {
     ...
     */
    @Deprecated(since = "6.2")
    default <P1, P2, T> CompositeProjectionOptionsStep<?, T> composite(BiFunction<P1, P2, T> transformer, SearchProjection<P1> projection1, SearchProjection<P2> projection2) {
     ...
     */
    @Deprecated(since = "6.2")
    default <P1, P2, P3, T> CompositeProjectionOptionsStep<?, T> composite(TriFunction<P1, P2, P3, T> transformer, SearchProjection<P1> projection1, SearchProjection<P2> projection2, SearchProjection<P3> projection3) {
     ...
     */
    @Incubating
    <T> ProjectionFinalStep<T> withParameters(Function<? super NamedValues, ? extends ProjectionFinalStep<T>> projectionCreator);
