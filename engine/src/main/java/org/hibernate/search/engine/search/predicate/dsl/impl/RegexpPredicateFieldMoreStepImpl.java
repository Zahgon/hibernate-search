...
class RegexpPredicateFieldMoreStepImpl<SR> implements RegexpPredicateFieldMoreStep<SR, RegexpPredicateFieldMoreStepImpl<SR>, RegexpPredicateOptionsStep<?>>, AbstractBooleanMultiFieldPredicateCommonState.FieldSetState {
    ...
    static class CommonState<SR> extends AbstractBooleanMultiFieldPredicateCommonState<CommonState<SR>, RegexpPredicateFieldMoreStepImpl<SR>> implements RegexpPredicateOptionsStep<CommonState<SR>> {
