...
public interface TypedSearchSortFactory<SR> extends SearchSortFactory {
     ...
     */
    @Incubating
    <T> FieldSortOptionsGenericStep<SR, T, ?, ?, ? extends TypedSearchPredicateFactory<SR>> field(FieldSortFieldReference<? super SR, T> fieldReference);
     ...
     */
    @Incubating
    default DistanceSortOptionsStep<SR, ?, ? extends TypedSearchPredicateFactory<SR>> distance(DistanceSortFieldReference<? super SR> fieldReference, GeoPoint location) {
     ...
     */
    @Override
    default DistanceSortOptionsStep<SR, ?, ? extends TypedSearchPredicateFactory<SR>> distance(String fieldPath, double latitude, double longitude) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Incubating
    default DistanceSortOptionsStep<SR, ?, ? extends TypedSearchPredicateFactory<SR>> distance(DistanceSortFieldReference<? super SR> fieldReference, double latitude, double longitude) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
