 ...
 */
public interface MatchPredicateOptionsStep<S extends MatchPredicateOptionsStep<?>> extends PredicateFinalStep, PredicateScoreStep<S>, CommonMinimumShouldMatchOptionsStep<S> {
