...
public interface RangePredicateFieldStep<SR, N extends RangePredicateFieldMoreStep<SR, ?, ?>> {
    ...
    default <T> RangePredicateFieldMoreGenericStep<SR, ?, ?, RangePredicateFieldReference<? super SR, T>, T> field(RangePredicateFieldReference<? super SR, T> fieldReference) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @SuppressWarnings("unchecked")
    <T> RangePredicateFieldMoreGenericStep<SR, ?, ?, RangePredicateFieldReference<? super SR, T>, T> fields(RangePredicateFieldReference<? super SR, T>... fields);
}
