...
public class AnnotationReportGenerator {
    ...
    private static void generateReport(String outputPath, String reportName, String annotationName, Index index, ReportGeneratorRules ignoreRules) throws IOException {
