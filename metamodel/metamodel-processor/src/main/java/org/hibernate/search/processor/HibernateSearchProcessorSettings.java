...
public final class HibernateSearchProcessorSettings {
    ...
    public record Configuration(boolean generatedAnnotationAdd, boolean generatedAnnotationTimestamp, String version) implements Serializable {

        public Configuration(Map<String, String> options) {
            this(Boolean.parseBoolean(options.getOrDefault(GENERATED_ANNOTATION_ADD, Defaults.GENERATED_ANNOTATION_ADD)), Boolean.parseBoolean(options.getOrDefault(GENERATED_ANNOTATION_TIMESTAMP, Defaults.GENERATED_ANNOTATION_TIMESTAMP)), Objects.toString(options.get(BACKEND_VERSION), null));
        }
