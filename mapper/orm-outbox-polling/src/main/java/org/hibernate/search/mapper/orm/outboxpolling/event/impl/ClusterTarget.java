    ...
    private static void assignStaticAgents(Agent[] candidatesInIdOrder, List<Agent> membersInShardOrder) {
        ...
        for (int i = 0; i < candidatesInIdOrder.length; i++) {
            ...
            if (firstStaticAgentTotalShardCount == null) {
                ...
                throw ConfigurationLog.INSTANCE.conflictingOutboxEventBackgroundProcessorAgentTotalShardCountForStaticSharding(agent.getReference(), agentStaticShardAssignment, firstStaticAgent.getReference(), firstStaticAgentTotalShardCount);
            }
            ...
            if (previouslyAssigned != null) {
                throw ConfigurationLog.INSTANCE.conflictingOutboxEventBackgroundProcessorAgentShardsForStaticSharding(agent.getReference(), agentStaticShardAssignment, previouslyAssigned.getReference());
            }
