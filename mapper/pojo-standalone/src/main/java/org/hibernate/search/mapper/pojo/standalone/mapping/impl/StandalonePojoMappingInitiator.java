...
public class StandalonePojoMappingInitiator extends AbstractPojoMappingInitiator<StandalonePojoMappingPartialBuildState> implements StandalonePojoMappingConfigurationContext {
    ...
    private static final ConfigurationProperty<Boolean> MAPPING_BUILD_MISSING_DISCOVERED_JANDEX_INDEXES = ConfigurationProperty.forKey(StandalonePojoMapperSettings.Radicals.MAPPING_BUILD_MISSING_DISCOVERED_JANDEX_INDEXES).asBoolean().withDefault(StandalonePojoMapperSettings.Defaults.MAPPING_BUILD_MISSING_DISCOVERED_JANDEX_INDEXES).build();

    private static final ConfigurationProperty<Boolean> MAPPING_DISCOVER_ANNOTATED_TYPES_FROM_ROOT_MAPPING_ANNOTATIONS = ConfigurationProperty.forKey(StandalonePojoMapperSettings.Radicals.MAPPING_DISCOVER_ANNOTATED_TYPES_FROM_ROOT_MAPPING_ANNOTATIONS).asBoolean().withDefault(StandalonePojoMapperSettings.Defaults.MAPPING_DISCOVER_ANNOTATED_TYPES_FROM_ROOT_MAPPING_ANNOTATIONS).build();
    ...
    private static final ConfigurationProperty<Boolean> MULTI_TENANCY_ENABLED = ConfigurationProperty.forKey(StandalonePojoMapperSettings.Radicals.MULTI_TENANCY_ENABLED).asBoolean().withDefault(StandalonePojoMapperSettings.Defaults.MULTI_TENANCY_ENABLED).build();
