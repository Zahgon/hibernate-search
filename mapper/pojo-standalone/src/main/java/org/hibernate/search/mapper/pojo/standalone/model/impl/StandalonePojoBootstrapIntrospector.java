 ...
 */
public class StandalonePojoBootstrapIntrospector extends AbstractPojoModelsBootstrapIntrospector implements PojoBootstrapIntrospector {

    public static StandalonePojoBootstrapIntrospector create(ClassResolver classResolver, ResourceResolver resourceResolver, IndexView indexView, ValueHandleFactory valueHandleFactory) {
    ...
    private StandalonePojoBootstrapIntrospector(ClassResolver classResolver, ResourceResolver resourceResolver, IndexView indexView, ValueHandleFactory valueHandleFactory) {
    ...
    private <T> PojoRawTypeModel<T> createTypeModel(Class<T> clazz) {
        ...
        try {
            return new PojoSimpleModelsRawTypeModel<>(this, typeIdentifier, new RawTypeDeclaringContext<>(genericContextHelper, clazz));
