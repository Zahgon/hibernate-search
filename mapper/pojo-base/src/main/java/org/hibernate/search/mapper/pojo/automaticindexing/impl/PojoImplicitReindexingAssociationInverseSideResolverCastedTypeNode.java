 ...
 */
class PojoImplicitReindexingAssociationInverseSideResolverCastedTypeNode<T, U> extends PojoImplicitReindexingAssociationInverseSideResolverNode<T> {
    ...
    public PojoImplicitReindexingAssociationInverseSideResolverCastedTypeNode(PojoCaster<? super U> caster, PojoImplicitReindexingAssociationInverseSideResolverNode<? super U> nested) {
        this.caster = caster;
        this.nested = nested;
    }
