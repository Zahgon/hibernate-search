...
public class CharArrayElementExtractor implements ContainerExtractor<char[], Character> {
    ...
    @Override
    public <T, C2> void extract(char[] container, ValueProcessor<T, ? super Character, C2> perValueProcessor, T target, C2 context, ContainerExtractionContext extractionContext) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
