...
public class DoubleArrayElementExtractor implements ContainerExtractor<double[], Double> {
    ...
    @Override
    public <T, C2> void extract(double[] container, ValueProcessor<T, ? super Double, C2> perValueProcessor, T target, C2 context, ContainerExtractionContext extractionContext) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
