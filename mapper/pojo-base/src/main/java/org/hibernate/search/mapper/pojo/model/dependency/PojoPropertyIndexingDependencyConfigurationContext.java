...
public interface PojoPropertyIndexingDependencyConfigurationContext {
     ...
     * @see #use(ContainerExtractorPath, PojoModelPathValueNode)
     */
    default PojoPropertyIndexingDependencyConfigurationContext use(ContainerExtractorPath extractorPathFromBridgedProperty, String pathFromExtractedBridgedPropertyValueToUsedValue) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Incubating
    default PojoOtherEntityIndexingDependencyConfigurationContext fromOtherEntity(Class<?> otherEntityType, String pathFromOtherEntityTypeToBridgedType) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Incubating
    default PojoOtherEntityIndexingDependencyConfigurationContext fromOtherEntity(Class<?> otherEntityType, PojoModelPathValueNode pathFromOtherEntityTypeToBridgedType) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Incubating
    PojoOtherEntityIndexingDependencyConfigurationContext fromOtherEntity(ContainerExtractorPath extractorPathFromBridgedProperty, Class<?> otherEntityType, PojoModelPathValueNode pathFromOtherEntityTypeToBridgedPropertyExtractedType);
}
