...
public class IntArrayElementExtractor implements ContainerExtractor<int[], Integer> {
    ...
    @Override
    public <T, C2> void extract(int[] container, ValueProcessor<T, ? super Integer, C2> perValueProcessor, T target, C2 context, ContainerExtractionContext extractionContext) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
