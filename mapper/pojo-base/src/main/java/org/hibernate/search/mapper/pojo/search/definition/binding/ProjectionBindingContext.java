...
public interface ProjectionBindingContext {
     ...
     * or a type of the container if the {@code P} values are wrapped in some type of container (e.g. {@code Optional<..>}, {@code Collection<..>}..).
     */
    <P, C> void definition(Class<P> expectedValueType, BeanHolder<? extends ProjectionDefinition<? extends C>> definitionHolder);
     ...
     */
    @Incubating
    default <T> BeanHolder<? extends ProjectionDefinition<T>> createObjectDefinition(String fieldPath, Class<T> projectedType, TreeFilterDefinition filter) {
    ...
    @Deprecated(since = "8.0")
    @Incubating
    default <T> BeanHolder<? extends ProjectionDefinition<List<T>>> createObjectDefinitionMulti(String fieldPath, Class<T> projectedType, TreeFilterDefinition filter) {
     ...
     */
    @Incubating
    <C, T> BeanHolder<? extends ProjectionDefinition<C>> createObjectDefinition(String fieldPath, Class<T> projectedType, TreeFilterDefinition filter, ProjectionCollector.Provider<T, C> collector);
