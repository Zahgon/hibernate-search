...
public final class PojoModelPathBinder {
    ...
    private static <C, T, P, V> V applyPath(C context, T rootNode, PojoModelPathValueNode unboundPathValueNode, PojoModelPathWalker<C, T, P, V> walker) {
    ...
    private static <C, T, P, V> P applyPath(C context, T rootNode, PojoModelPathPropertyNode unboundPathPropertyNode, PojoModelPathWalker<C, T, P, V> walker) {
