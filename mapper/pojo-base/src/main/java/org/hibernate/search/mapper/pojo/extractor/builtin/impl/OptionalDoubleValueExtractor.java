...
public class OptionalDoubleValueExtractor implements ContainerExtractor<OptionalDouble, Double> {
    ...
    @Override
    public <T, C2> void extract(OptionalDouble container, ValueProcessor<T, ? super Double, C2> perValueProcessor, T target, C2 context, ContainerExtractionContext extractionContext) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
