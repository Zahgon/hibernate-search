...
class HibernateOrmClassPropertyModel<T> extends AbstractPojoModelsPropertyModel<T, HibernateOrmBootstrapIntrospector> {

    private final HibernateOrmBasicClassPropertyMetadata ormPropertyMetadata;

    HibernateOrmClassPropertyModel(HibernateOrmBootstrapIntrospector introspector, HibernateOrmClassRawTypeModel<?> holderTypeModel, String name, List<MemberDetails> declaredProperties, HibernateOrmBasicClassPropertyMetadata ormPropertyMetadata, List<Member> members) {
