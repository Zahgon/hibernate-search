...
public final class Search {
    ...
    private static SearchSession createSearchSession(Session session) {
        HibernateSearchContextProviderService mappingContextProvider = HibernateSearchContextProviderService.get(HibernateOrmUtils.toSessionFactoryImplementor(session.getSessionFactory()));
