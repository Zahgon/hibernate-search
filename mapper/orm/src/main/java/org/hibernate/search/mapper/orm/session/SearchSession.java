...
public interface SearchSession extends SearchScopeProvider {
    ...
    default <T> SearchQuerySelectStep<NonStaticMetamodelScope, ?, org.hibernate.search.mapper.orm.common.EntityReference, T, SearchLoadingOptionsStep, ?, ?> search(Class<T> clazz) {
     ...
     */
    @SuppressWarnings("deprecation")
    <T> SearchQuerySelectStep<NonStaticMetamodelScope, ?, org.hibernate.search.mapper.orm.common.EntityReference, T, SearchLoadingOptionsStep, ?, ?> search(Collection<? extends Class<? extends T>> classes);
     ...
     */
    @SuppressWarnings("deprecation")
    <SR, T> SearchQuerySelectStep<SR, ?, org.hibernate.search.mapper.orm.common.EntityReference, T, SearchLoadingOptionsStep, ?, ?> search(TypedSearchScope<SR, T> scope);
    ...
    @SuppressWarnings("deprecation")
    @Incubating
    <SR, T> SearchQuerySelectStep<SR, ?, org.hibernate.search.mapper.orm.common.EntityReference, T, SearchLoadingOptionsStep, ?, ?> search(HibernateOrmRootReferenceScope<SR, T> scope);
