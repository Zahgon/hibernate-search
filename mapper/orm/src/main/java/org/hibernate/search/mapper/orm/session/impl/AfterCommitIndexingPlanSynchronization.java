...
class AfterCommitIndexingPlanSynchronization implements Synchronization {
    ...
    AfterCommitIndexingPlanSynchronization(PojoIndexingPlan indexingPlan, HibernateOrmSearchSessionExtension sessionExtension, Transaction transactionIdentifier, ConfiguredIndexingPlanSynchronizationStrategy synchronizationStrategy) {
