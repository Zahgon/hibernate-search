...
public abstract class AbstractLuceneLeafSingleFieldPredicate extends AbstractLuceneSingleFieldPredicate {
    ...
    public abstract static class AbstractBuilder<F> extends AbstractLuceneSingleFieldPredicate.AbstractBuilder {
        ...
        protected <E> Range<E> convertAndEncode(LuceneFieldCodec<F, E> codec, Range<?> range, ValueModel lowerBoundModel, ValueModel upperBoundModel) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }

        private <E> E convertAndEncode(LuceneFieldCodec<F, E> codec, Optional<?> valueOptional, ValueModel valueModel) {
