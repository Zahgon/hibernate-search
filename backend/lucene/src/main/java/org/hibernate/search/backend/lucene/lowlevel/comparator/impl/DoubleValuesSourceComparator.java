...
public class DoubleValuesSourceComparator extends DoubleComparator {
    ...
    public DoubleValuesSourceComparator(int numHits, String field, Double missingValue, boolean reversed, Pruning ignored, DoubleMultiValuesToSingleValuesSource source) {
