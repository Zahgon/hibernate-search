...
public class LuceneObjectProjection<E, V, P> extends AbstractLuceneProjection<P> {
    ...
    private LuceneObjectProjection(Builder builder, LuceneSearchProjection<?>[] inners, ResultsCompositor<E, V> compositor, ProjectionCollector.Provider<V, P> collectorProvider) {
        super(builder.scope);
