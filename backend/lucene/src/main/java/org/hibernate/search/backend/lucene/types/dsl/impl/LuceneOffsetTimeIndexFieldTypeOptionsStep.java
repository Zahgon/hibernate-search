...
class LuceneOffsetTimeIndexFieldTypeOptionsStep extends AbstractLuceneTemporalIndexFieldTypeOptionsStep<LuceneOffsetTimeIndexFieldTypeOptionsStep, OffsetTime> {
    ...
    @Override
    protected AbstractLuceneNumericFieldCodec<OffsetTime, ?> createCodec(Indexing indexing, DocValues docValues, Storage storage, OffsetTime indexNullAsValue) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
