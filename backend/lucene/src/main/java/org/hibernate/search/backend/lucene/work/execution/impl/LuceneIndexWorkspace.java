...
public class LuceneIndexWorkspace implements IndexWorkspace {
    ...
    @Override
    public CompletableFuture<?> mergeSegments(OperationSubmitter operationSubmitter, // mergeSegments is always supported
    ...
    @Override
    public CompletableFuture<?> flush(OperationSubmitter operationSubmitter, // flush is always supported
    UnsupportedOperationBehavior ignored) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }

    @Override
    public CompletableFuture<?> refresh(OperationSubmitter operationSubmitter, // refresh is always supported
    UnsupportedOperationBehavior ignored) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
