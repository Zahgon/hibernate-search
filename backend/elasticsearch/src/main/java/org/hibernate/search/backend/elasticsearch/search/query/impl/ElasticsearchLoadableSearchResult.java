...
public class ElasticsearchLoadableSearchResult<H> {
    ...
    ElasticsearchLoadableSearchResult(ElasticsearchSearchQueryExtractContext extractContext, ElasticsearchSearchProjection.Extractor<?, H> extractor, SearchResultTotal resultTotal, List<Object> extractedHits, Map<AggregationKey<?>, ?> extractedAggregations, Integer took, Boolean timedOut, String scrollId, Deadline deadline) {
