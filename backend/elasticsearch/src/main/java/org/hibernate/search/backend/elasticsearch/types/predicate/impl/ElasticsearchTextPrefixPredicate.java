...
public class ElasticsearchTextPrefixPredicate extends AbstractElasticsearchSingleFieldPredicate {
    ...
    public static class Factory extends AbstractElasticsearchValueFieldSearchQueryElementFactory<PrefixPredicateBuilder, String> {

        @Override
        public PrefixPredicateBuilder create(ElasticsearchSearchIndexScope<?> scope, ElasticsearchSearchIndexValueFieldContext<String> field) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
    }
