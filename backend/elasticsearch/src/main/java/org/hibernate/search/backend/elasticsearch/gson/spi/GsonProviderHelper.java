...
public final class GsonProviderHelper {
	 ...
	 */
    private static final Set<TypeToken<?>> TYPES_CAUSING_GSON_CONCURRENT_INITIALIZATION_BUG = CollectionHelper.asImmutableSet(TypeToken.get(IndexSettings.class), TypeToken.get(RootTypeMapping.class));
