...
public interface ElasticsearchSearchProjection<P> extends SearchProjection<P> {
    ...
    interface Extractor<E, P> {
         ...
         */
        E extract(ProjectionHitMapper<?> projectionHitMapper, JsonObject hit, JsonObject source, ProjectionExtractContext context);
        ...
        static <Z> Z transformUnsafe(Extractor<?, Z> extractor, LoadingResult<?> loadingResult, Object extractedData, ProjectionTransformContext context) {
