...
public class AnalysisJsonAdapterFactory extends AbstractConfiguredExtraPropertiesJsonAdapterFactory {
    ...
    private static final TypeToken<Map<String, AnalyzerDefinition>> ANALYZER_DEFINITIONS_MAP_TYPE_TOKEN = new TypeToken<Map<String, AnalyzerDefinition>>() {
    };

    private static final TypeToken<Map<String, NormalizerDefinition>> NORMALIZER_DEFINITIONS_MAP_TYPE_TOKEN = new TypeToken<Map<String, NormalizerDefinition>>() {
    };

    private static final TypeToken<Map<String, TokenizerDefinition>> TOKENIZER_DEFINITIONS_MAP_TYPE_TOKEN = new TypeToken<Map<String, TokenizerDefinition>>() {
    };

    private static final TypeToken<Map<String, TokenFilterDefinition>> TOKEN_FILTER_DEFINITIONS_MAP_TYPE_TOKEN = new TypeToken<Map<String, TokenFilterDefinition>>() {
    };

    private static final TypeToken<Map<String, CharFilterDefinition>> CHAR_FILTER_DEFINITIONS_MAP_TYPE_TOKEN = new TypeToken<Map<String, CharFilterDefinition>>() {
    };
