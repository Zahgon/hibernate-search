...
public class ClientOpenSearchElasticsearchClient implements ElasticsearchClientImplementor {
    ...
    ClientOpenSearchElasticsearchClient(BeanHolder<? extends RestClient> restClientHolder, Sniffer sniffer, SimpleScheduledExecutor timeoutExecutorService, Optional<Integer> requestTimeoutMs, Gson gson, JsonLogHelper jsonLogHelper) {
    ...
    private void setPerRequestSocketTimeout(ElasticsearchRequest elasticsearchRequest, Request request) {
        ...
        Timeout.DISABLED).setResponseTimeout(generalRequestTimeoutMs, TimeUnit.MILLISECONDS).build();
