...
public class ToStringStyle {
    ...
    private ToStringStyle(String newline, String entrySeparator, String nameValueSeparator, String startObject, String endObject, String indentInObject, String startList, String endList, String indentInListBulletPoint, String indentInListNoBulletPoint, boolean squeezeObjectsInList) {
