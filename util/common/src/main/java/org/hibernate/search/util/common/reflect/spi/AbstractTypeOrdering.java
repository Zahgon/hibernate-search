...
public abstract class AbstractTypeOrdering<T> {
    ...
    private void collectSuperTypesAscending(Set<T> result, T subType) {
        ...
        declaredInterfaces(subType).forEach(interfaze -> collectSuperTypesAscending(result, interfaze));
    ...
    private void collectSuperTypesDescending(Set<T> result, T subType) {
        ...
        declaredInterfaces(subType).forEach(interfaze -> collectSuperTypesDescending(result, interfaze));
        result.add(subType);
    }
}
