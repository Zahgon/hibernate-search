...
class LuceneIndexValueFieldTemplateBuilder extends AbstractLuceneIndexFieldTemplateBuilder<LuceneIndexValueFieldTemplateBuilder, LuceneIndexValueFieldTemplate> {

    private final LuceneIndexValueFieldType<?> type;

    LuceneIndexValueFieldTemplateBuilder(AbstractLuceneIndexCompositeNodeBuilder parent, String templateName, TreeNodeInclusion inclusion, LuceneIndexValueFieldType<?> type, String prefix) {
