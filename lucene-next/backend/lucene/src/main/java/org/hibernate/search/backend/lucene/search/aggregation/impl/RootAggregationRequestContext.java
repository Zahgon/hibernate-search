...
public final class RootAggregationRequestContext implements AggregationRequestContext {
    ...
    public RootAggregationRequestContext(LuceneSearchQueryIndexScope<?, ?> queryIndexScope, BackendSessionContext sessionContext, Set<String> routingKeys, ExtractionRequirements.Builder extractionRequirementsBuilder, QueryParameters parameters) {
