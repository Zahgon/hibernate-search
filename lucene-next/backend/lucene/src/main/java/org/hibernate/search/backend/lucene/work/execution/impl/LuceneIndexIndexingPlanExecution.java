...
class LuceneIndexIndexingPlanExecution {
    ...
    LuceneIndexIndexingPlanExecution(LuceneSerialWorkOrchestrator orchestrator, EntityReferenceFactory entityReferenceFactory, DocumentCommitStrategy commitStrategy, DocumentRefreshStrategy refreshStrategy, List<SingleDocumentIndexingWork> works) {
