...
class LuceneDoubleIndexFieldTypeOptionsStep extends AbstractLuceneNumericIndexFieldTypeOptionsStep<LuceneDoubleIndexFieldTypeOptionsStep, Double> {
    ...
    @Override
    protected AbstractLuceneNumericFieldCodec<Double, ?> createCodec(Indexing indexing, DocValues docValues, Storage storage, Double indexNullAsValue) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }

    @Override
    protected AbstractLuceneCodecAwareSearchQueryElementFactory<FieldMetricAggregationBuilder.TypeSelector, Double, AbstractLuceneNumericFieldCodec<Double, ?>> sumMetricAggregationFactory(AbstractLuceneNumericFieldCodec<Double, ?> codec) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }

    @Override
    protected AbstractLuceneCodecAwareSearchQueryElementFactory<FieldMetricAggregationBuilder.TypeSelector, Double, AbstractLuceneNumericFieldCodec<Double, ?>> avgMetricAggregationFactory(AbstractLuceneNumericFieldCodec<Double, ?> codec) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
