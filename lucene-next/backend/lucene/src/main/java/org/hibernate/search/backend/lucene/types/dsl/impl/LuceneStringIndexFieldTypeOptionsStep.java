...
class LuceneStringIndexFieldTypeOptionsStep extends AbstractLuceneStandardIndexFieldTypeOptionsStep<LuceneStringIndexFieldTypeOptionsStep, String> implements StringIndexFieldTypeOptionsStep<LuceneStringIndexFieldTypeOptionsStep> {
    ...
    private ResolvedTermVector resolveTermVector() {
        ...
        if (highlightable != null && (highlightable.contains(Highlightable.ANY) || highlightable.contains(Highlightable.FAST_VECTOR))) {
